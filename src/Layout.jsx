            ...
            {filteredItems.map((item) => {
              ...
              return (
                <SidebarMenuItem key={item.title}>
                  ...
                  >
                    <Link to={item.url} className="flex items-center gap-3 px-4 py-2.5 no-underline">
                ...
                <SidebarGroupContent>
                  <SidebarMenu>
                    <SidebarMenuItem>
                      ...
                      >
                        <Link to={createPageUrl("DebugDashboard")} className="flex items-center gap-3 px-4 py-2.5 no-underline">
